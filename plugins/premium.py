...
async def check_premium_expired(bot):
    ...
    while True:
        try:
            ...
            # ✅ कर्सर रैम लीक को रोकने के लिए केवल आवश्यक फील्ड्स मंगवाईं (Projection Added)
        ...
        # ✅ चाहे एरर आए या न आए, 60 सेकंड का स्लीप हमेशा अंत में सिक्योर रहेगा ताकि CPU ब्लास्ट न हो
